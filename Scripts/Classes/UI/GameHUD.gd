...
func handle_pausing() -> void:
	if get_tree().get_first_node_in_group("Players") != null and Global.can_pause and ((Global.current_game_mode != Global.GameMode.LEVEL_EDITOR) or Global.level_editor_is_playtesting()):
